...
compute_wavelet_filter <- function(type,par){
  ####
  ...
  if (type == 'Daubechies'){
    ...
    if (par == 1){
      ...
      f <- c(.054415842243,.312871590914,.675630736297,
      ...
      f <- c(.038077947364,.243834674613,.604823123690,
      ...
      f <- c(.026670057901,.188176800078,.527201188932,
      ...
      error("Wrong arguments, see comments for acceptable values")
    }
