...
MathJax.Hub.Config({
  ...
  //
  styleSheets: ["TeX-AMS-MML_SVG.js"],
...
//    ['$','$'],      // uncomment this for standard TeX math delimiters
  ...
  TeX: {
    ...
    Macros: { 
	      ...
	      linf: '\\ell^\infty',
	      Lun: '\\text{\\upshape L}^1',
	      Ldeux: '\\text{\\upshape L}^2',
	      Lp: '\\text{\\upshape L}^p',
	      Lq: '\\text{\\upshape L}^q',
	      Linf: '\\text{\\upshape L}^\infty',
	      lzero: '\\ell^0',
	      lp: '\\ell^p',
	      argmin: '\\text{argmin}\\quad',
	      argmax: '\\text{argmax}',
	      d: '\\ins{d}',
	      Grad: '\\text{Grad}',
	      grad: '\\text{grad}',
	      ...
	      qqandqq: ' \\qquad \\text{and} \\qquad ',
	      qifq: ' \\quad \\text{if} \\quad ',
	      qqifqq: ' \\qquad \\text{if} \\qquad ',
	      qwhereq: ' \\quad \\text{where} \\quad ',
	      qqwhereqq: ' \\qquad \\text{where} \\qquad ',
	      qwithq: ' \\quad \\text{with} \\quad ',
	      qqwithqq: ' \\qquad \\text{with} \\qquad ',
	      qforq: ' \\quad \\text{for} \\quad ',
	      qqforqq: ' \\qquad \\text{for} \\qquad ',
	      qqsinceqq: ' \\qquad \\text{since} \\qquad ',
	      qsinceq: ' \\quad \\text{since} \\quad ',
	      qarrq: '\\\quad\Longrightarrow\\quad',
	      qqarrqq: '\\\quad\Longrightarrow\\quad',
	      qiffq: '\\\quad\Longleftrightarrow\\quad',
	      qqiffqq: '\\\qquad\Longleftrightarrow\\qquad',
	      qsubjq: ' \\quad \\text{subject to} \\quad ',
	      qqsubjqq: ' \\qquad \\text{subject to} \\qquad',
		  ////////////// 1 ARGUMENT //////////////
	      norm: ['\\| #1 \\|', 1],
	      normi: ['\\norm{#1}_{\\infty}', 1],
	      normu: ['\\norm{#1}_{1}', 1],
	      normz: ['\\norm{#1}_{0}', 1],
	      abs: ['\\vert #1 \\vert', 1],
	      uargmin: ['\\underset{#1}{\\argmin}\\;', 1],
	      uargmax: ['\\underset{#1}{\\argmax}\\;', 1],
	      umin: ['\\underset{#1}{\\min}\\;', 1],
	      umax: ['\\underset{#1}{\\max}\\;', 1],
	      pa: ['\\left( #1 \\right)', 1],
	      choice: [' \\left\\{  \\begin{array}{l} #1 \\end{array} \\right.', 1],
		  ////////////// 2 ARGUMENTS //////////////
	      pd: ['\\frac{ \\partial #1 }{ \\partial #2}', 2],
	      pdd: [' \\frac{ \\partial^2 #1 }{ \\partial #2^2}', 2],
	      dotp: ['\\langle #1,\\,#2\\rangle', 2],
	      enscond: [' \\left\\{ #1 \\;:\\; #2 \\right\\}', 2],
	},
...
MathJax.Ajax.loadComplete("https://github.com/gpeyre/numerical-tours/blob/master/matlab/html/mathjax_config.js");
